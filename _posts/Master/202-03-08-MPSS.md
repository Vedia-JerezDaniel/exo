...
The [***tone_count module***](https://github.com/Vedia-JerezDaniel/exo/blob/master/code_posts/tone_count.py) is available here at my Github page.
...
![alt]({{ site.url }}{{ site.baseurl }}/images/Master/net.png)
...
​    
![alt]({{ site.url }}{{ site.baseurl }}/images/Master/boe_rate.png)
​    
...
![alt]({{ site.url }}{{ site.baseurl }}/images/Master/final.png)
